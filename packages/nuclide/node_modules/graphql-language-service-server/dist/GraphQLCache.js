...
var GraphQLCache = exports.GraphQLCache = function () {
  function GraphQLCache(configDir, graphQLConfig) {
    ...
    this.handleWatchmanSubscribeEvent = function (rootDir, projectConfig) {
      return function (result) {
        if (result.files && result.files.length > 0) {
          ...
          result.files.forEach(function _callee4(_ref2) {
            var name = _ref2.name,
                exists = _ref2.exists,
                size = _ref2.size,
                mtime = _ref2.mtime;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 13:
                    ...
                    _context5.t0 = _this._graphQLFileListCache;
                    _context5.t1 = rootDir;
                    _context5.next = 18;
    ...
    this.getSchema = function _callee5(appName) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 3:
              ...
              return _context6.abrupt('return', schema && queryHasExtensions ? _this._extendSchema(schema, schemaPath, schemaCacheKey) : schema);
      ...
      return regeneratorRuntime.async(function _callee6$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 9:
              return _context7.abrupt('return', _this.processGraphQLFiles(responses));
        ...
        return _fs2.default.readFile(filePath, 'utf8', function (error, content) {
          ...
          if (content.trim().length !== 0) {
            try {
              ...
              queries.forEach(function (_ref3) {
  ...
  GraphQLCache.prototype.updateFragmentDefinitionCache = function updateFragmentDefinitionCache(rootDir, filePath, exists) {
    ...
    return regeneratorRuntime.async(function updateFragmentDefinitionCache$(_context10) {
      while (1) {
