...
const createLastReturnedMatcher = matcherName => (received, expected) => {
  ...
  const pass = (0, _jasmine_utils.equals)(lastReturnValue, expected, [
    _utils.iterableEquality
  ]);
  ...
  const message = pass
    ? () =>
        ...
        `  ${(0, _jestMatcherUtils.printReceived)(lastReturnValue)}`
    : () =>
        (0, _jestMatcherUtils.matcherHint)(
          matcherName,
          received.getMockName()
        ...
        (returnValues.length > 0
          ...
          : `But it did ${(0, _jestMatcherUtils.RECEIVED_COLOR)(
              'not return'
            )}`);
...
const createNthReturnedWithMatcher = matcherName => (
  ...
  const pass = (0, _jasmine_utils.equals)(nthValue, expected, [
    _utils.iterableEquality
  ]);
  ...
  const message = pass
    ? () =>
        ...
        `  ${(0, _jestMatcherUtils.printReceived)(nthValue)}`
    : () =>
        (0, _jestMatcherUtils.matcherHint)(
          matcherName,
          received.getMockName()
        ...
        (returnValues.length > 0
          ? `But the ${nthString} call returned with:\n  ${(0,
            _jestMatcherUtils.printReceived)(nthValue)}`
          : `But it did ${(0, _jestMatcherUtils.RECEIVED_COLOR)(
              'not return'
            )}`);
