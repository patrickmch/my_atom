...
import { Command, TextEdit, CodeAction, CodeActionKind, TextDocumentEdit } from 'vscode-languageserver-types';
...
var CSSCodeActions = /** @class */ (function () {
    ...
    CSSCodeActions.prototype.getFixesForUnknownProperty = function (document, property, marker, result) {
        ...
        for (var _i = 0, candidates_1 = candidates; _i < candidates_1.length; _i++) {
            ...
            var workspaceEdit = { documentChanges: [TextDocumentEdit.create(document, [edit])] };
